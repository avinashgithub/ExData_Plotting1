...
# Graph in 1, 2 position
with(febSet, plot(datetime, Voltage, type='l'))

# Graph in 2, 1 position
with (febSet, {
...
#Graph in 2, 2 position
with(febSet, plot(datetime, Global_reactive_power, type='l'))
dev.off()
